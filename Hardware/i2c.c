...
/***************************************************************************/
#define SDA_IN()   {GPIOF->MODER &= ~(3U << (5 * 2));}
#define SDA_OUT()  {GPIOF->MODER &= ~(3U << (5 * 2)); GPIOF->MODER |= (1U << (5 * 2));}
#define READ_SDA   (GPIOF->IDR & GPIO_Pin_5)
#define IIC_SCL_1  GPIO_SetBits(GPIOF,GPIO_Pin_4)//SCL
#define IIC_SCL_0  GPIO_ResetBits(GPIOF,GPIO_Pin_4)
#define IIC_SDA_1  GPIO_SetBits(GPIOF,GPIO_Pin_5)//SDA
#define IIC_SDA_0  GPIO_ResetBits(GPIOF,GPIO_Pin_5)
void GPIO_I2c(void)
{
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOF, ENABLE);
   	GPIO_InitTypeDef  GPIOF_InitStructure;
    GPIOF_InitStructure.GPIO_Pin = GPIO_Pin_4|GPIO_Pin_5;
